...
var gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0) => {
	...
	if (targetBlockElement) {
		...
		if (window.lenis) window.lenis.scrollTo(targetBlockElementPosition);
...
//#endregion
//#region src/components/effects/lenis/lenis.js
function lenisInit() {
	window.lenis = new Lenis({ autoRaf: true });
}
document.documentElement.hasAttribute("data-fls-lenis") && window.addEventListener("load", lenisInit);
//#endregion
export { getDocument as _, Navigation as a, classesToTokens as c, elementOffset as d, elementOuterSize as f, setInnerHTML as g, nextTick as h, classesToSelector as i, createElement as l, makeElementsArray as m, getHash as n, createElementIfNotDefined as o, elementParents as p, gotoBlock as r, Swiper as s, bodyUnlock as t, elementIndex as u };
